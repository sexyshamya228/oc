...
class RTL_OSVERSIONINFOW(ctypes.Structure):
    _fields_ = [
        ("dwOSVersionInfoSize", wt.DWORD),      # Размер структуры (обязателен при вызове)
        ("dwMajorVersion", wt.DWORD),           # Главная версия Windows (например 10)
...
class SYSTEM_INFO(ctypes.Structure):
    _fields_ = [
        ...
        ("dwProcessorType", wt.DWORD),         # Тип процессора (Intel/AMD и т.п.)
